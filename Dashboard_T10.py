...
st.markdown("<div class='titulo-cabecalho'>Análise Visual do Homicídio de Mulheres no Brasil<p>Disciplina: Computação Visual- Discente: Alex Gondim</p></div>", unsafe_allow_html=True)
...
caminho_do_arquivo = 'C:\\Users\\Raphael\\Desktop\\RefatradoVC\\vitimas.xlsx' 
df = pd.read_excel(caminho_do_arquivo)  
df1 = pd.read_excel(r'C:\Users\Raphael\Desktop\RefatradoVC\homicidios-mulheres-nao-negras.xlsx')
df2 = pd.read_excel(r'C:\Users\Raphael\Desktop\RefatradoVC\homicidios-mulheres-negras.xlsx')
...
if selected_chart == "EVAHMNN- Mapa de Calor":
    ...
    try:
        color_scale = px.colors.diverging.Portland  
        fig_sunburst = px.sunburst(df_grouped,
                           path=['UF', 'Ano'],
                           values='Vítimas',
                           color='Vítimas',
                           color_continuous_scale=color_scale)  
